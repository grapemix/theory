...
# Theory modification: try to use the system version first, providing it's
...
if not use_system_version:
  ...
  from theory.utils.simplejson.decoder import JSONDecoder
  from theory.utils.simplejson.encoder import JSONEncoder
