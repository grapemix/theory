...
UiReq = _reflection.GeneratedProtocolMessageType('UiReq', (_message.Message,), {
  'DESCRIPTOR' : _UIREQ,
...
ReactorReq = _reflection.GeneratedProtocolMessageType('ReactorReq', (_message.Message,), {
...
ReactorReqArr = _reflection.GeneratedProtocolMessageType('ReactorReqArr', (_message.Message,), {
...
UiId = _reflection.GeneratedProtocolMessageType('UiId', (_message.Message,), {
  'DESCRIPTOR' : _UIID,
  '__module__' : 'theory_pb2'
...
CmdFxnInput = _reflection.GeneratedProtocolMessageType('CmdFxnInput', (_message.Message,), {
...
uiData4Adapter = _reflection.GeneratedProtocolMessageType('uiData4Adapter', (_message.Message,), {
...
JsonData = _reflection.GeneratedProtocolMessageType('JsonData', (_message.Message,), {
...
MdlIden = _reflection.GeneratedProtocolMessageType('MdlIden', (_message.Message,), {
  'DESCRIPTOR' : _MDLIDEN,
  '__module__' : 'theory_pb2'
...
MdlTblReq = _reflection.GeneratedProtocolMessageType('MdlTblReq', (_message.Message,), {
...
Mdl = _reflection.GeneratedProtocolMessageType('Mdl', (_message.Message,), {

  'MdlEntry' : _reflection.GeneratedProtocolMessageType('MdlEntry', (_message.Message,), {
...
MultiModelLstData = _reflection.GeneratedProtocolMessageType('MultiModelLstData', (_message.Message,), {
...
ModelLstData = _reflection.GeneratedProtocolMessageType('ModelLstData', (_message.Message,), {
...
StrVsMap = _reflection.GeneratedProtocolMessageType('StrVsMap', (_message.Message,), {

  'VEntry' : _reflection.GeneratedProtocolMessageType('VEntry', (_message.Message,), {
...
StrLst = _reflection.GeneratedProtocolMessageType('StrLst', (_message.Message,), {
  'DESCRIPTOR' : _STRLST,
  '__module__' : 'theory_pb2'
...
IntLst = _reflection.GeneratedProtocolMessageType('IntLst', (_message.Message,), {
  'DESCRIPTOR' : _INTLST,
  '__module__' : 'theory_pb2'
...
SpreadSheetData = _reflection.GeneratedProtocolMessageType('SpreadSheetData', (_message.Message,), {
...
_MDL_MDLENTRY._options = None
_STRVSMAP_VENTRY._options = None
